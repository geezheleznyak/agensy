...
# Shared parsing layer — see _vault_utils.py for definitions.
from _vault_utils import (
    setup_utf8_stdout,
    VaultConfig,
    parse_frontmatter, has_valid_frontmatter, get_body,
    get_wikilinks, get_section, section_exists,
    is_infrastructure, should_skip_dir, discover_notes,
    build_link_index, resolve_link,
    MAP_SUFFIXES, INFRA_PATTERNS, BASE_FIELDS,
)
